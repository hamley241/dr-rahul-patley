// src/assessments.jsx — ASRS-v1.1, PHQ-9, GAD-7
...
function AssessmentModal({ kind, onClose }) {
  const cfg = ASSESS[kind];
  const [step, setStep] = React.useState(0);
  const [answers, setAnswers] = React.useState(() => new Array(cfg.questions.length).fill(null));
...
Object.assign(window, { ASSESS, AssessmentModal });
