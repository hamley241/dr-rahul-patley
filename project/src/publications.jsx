// src/publications.jsx — curated highlights + full archive modal with filtering

// Tag normalization for clean display labels
const TAG_LABELS = {
...
// Tags to exclude from filter chips (publication type tags, redundant)
const EXCLUDED_FILTER_TAGS = new Set(['article','book','chapter','poster','conference-paper','preprint']);

// Hand-picked highlights for homepage (6 most representative)
const HIGHLIGHT_IDS = [
...
function Research() {
  ...
  const pubs = window.DATA_publications_full || [];
...
function PublicationsArchive({ onClose }) {
  ...
  // Compute top tags by frequency, limited to 8
...
Object.assign(window, { Research, PublicationsArchive });
